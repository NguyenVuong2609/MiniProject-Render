...
// if (paidNum <= 50) {
//   payment = paidNum * level1;
// } else if (paidNum <= 100) {
//   payment = 50 * level1 + (paidNum - 50) * level2;
// } else if (paidNum <= 150) {
//   payment = 50 * level1 + 50 * level2 + (paidNum - 100) * level3;
// } else {
//   payment = 50 * level1 + 50 * level2 + 50 * level3 + (paidNum - 150) * level4;
// }
// console.log(payment);